...
class GameMain:
    def __init__(self):
        ...
        states = {
            ...
            'serve': ServeState(self.g_state_manager),
            'victory': VictoryState(self.g_state_manager),
            'paddle-select': PaddleSelectState(self.g_state_manager),
            'high-scores': HighScoreState(self.g_state_manager),
            'enter-high-score': EnterHighScoreState(self.g_state_manager),
