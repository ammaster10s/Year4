...
class GameMain:
    def __init__(self):
        ...
        self.bg_image = pygame.image.load(os.path.join(BASE_DIR, "graphics/background.png"))
        ...
        self.bg_music = pygame.mixer.Sound(os.path.join(BASE_DIR, 'sounds/music.wav'))
    ...
    def LoadHighScores(self):
        rank_file = os.path.join(BASE_DIR, RANK_FILE_NAME)
